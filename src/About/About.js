      ...
      <section id="hartsol-about" className="hartsol-view">
      	<div className="hartsol-section-container">
	      	...
	      	<article className="content-half">
				...
				<p>Then I joined <a href="#">Danube Building Materials FZCO</a> as UI/Front End Developer in June 2014. I was task to develop their online shop, make it SEO ready and manage all the company websites under danube umbrella.</p>
				<p>On December 2015 <a href="#">Leader Healthcare</a> hired me to manage their website, do the SEO, create landing pages for products to promote namely Hydrafacial, Zoll, Sam Medical, Heyer Medical, Morizne and more..</p>
				...
				<p>Right now I work as senior web developer in ( OBG ) <a href="#">One Broker Group</a> a real estate based in Dubai, UAE. Focused on landing pages creation, commissioned the OBG Site, implemented keywords for SEO</p>
			</article>
